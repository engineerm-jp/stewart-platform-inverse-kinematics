...
class StewartPlatformKinematics:
    ...
    def __init__(self):
        ...
        self.L_B = 0.073    #  Length between the base joints
        self.L_P = 0.06     #  Length between the platform joints
        self.L_bar = 0.07   #  Length of the bars
        self.L_servo = 0.045#  Length of the servo arm
        ...
        ## Rotations of the base joints' axes relative to the base origin frame BO
